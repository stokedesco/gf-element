...
namespace GravityKit\GravityFormsElementorWidget\Foundation\Integrations;

use GravityKit\GravityFormsElementorWidget\Foundation\Core as FoundationCore;
	...
	public function get_beacon_label_translations() {
		$translations = [
			...
			'attachmentSizeErrorText'         => strtr(
				_x( 'The maximum file size is [size]', 'Placeholders inside [] are not to be translated.', 'gk-foundation' ),
			...
			'chatEnded'                       => strtr(
				_x( '[name] ended the chat', 'Placeholders inside [] are not to be translated.', 'gk-foundation' ),
				[ '[name]' => '' ] // HS has a blank space before the translation.
			),
			'chatConnected'                   => strtr(
				_x( 'Connected to [name]', 'Placeholders inside [] are not to be translated.', 'gk-foundation' ),
			...
			'chatbotAgentDisconnectedMessage' => strtr(
				_x( '[name] has disconnected from the chat. It\'s possible they lost their internet connection, so I\'m looking for someone else to take over. Sorry for the delay!', 'Placeholders inside [] are not to be translated.', 'gk-foundation' ),
				[ '[name]' => '' ] // HS has a blank space before the translation.
			),
			...
			// Transcript Email.
			'emailHeading'                    => strtr(
				_x( 'Today\'s chat with [name]', 'Placeholders inside [] are not to be translated.', 'gk-foundation' ),
				[ '[name]' => '' ] // HS has a blank space after the translation.
			),
			'emailGreeting'                   => strtr(
				_x( 'Hey [name]', 'Placeholders inside [] are not to be translated.', 'gk-foundation' ),
				[ '[name]' => '' ] // HS has a blank space after the translation.
			),
			...
			'emailJoinedLineItem'             => strtr(
                _x( '[name] joined the chat', 'Placeholders inside [] are not to be translated.', 'gk-foundation' ),
				[ '[name]' => '' ] // HS has a blank space before the translation.
			),
